...
//       author: "Unknown",
//       img: "Madan no Ichi(Ichi the Witch).jpg",
//       description: "Madan no Ichi follows Ichi, a powerful witch who combats dark magical threats to protect her world, mixing mystery and fantasy."
//     }
//   ]
// };
...
function showAllBooks(category) {
    ...
    const booksGrid = bookList.map(book => `
    ...
    const modal = createModal(`
        <div class="modal-header">
            <h2>${category.charAt(0).toUpperCase() + category.slice(1)} Anime Books</h2>
            <button class="close-btn" onclick="closeModal()">&times;</button>
        </div>
        <div class="modal-content">
